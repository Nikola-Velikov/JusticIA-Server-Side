...
основния правен термин от въпроса и да Генерираш най на важното ама наистина най най важното ГЕНЕРИРАШ (само съществително или правно понятие, не глагол),
...
- Ако въпросът съдържа и действие, и обект (напр. „Какви  са правомощия на общото събрание на етажната собственост?“), терминът е само обектът → „собственост“.
